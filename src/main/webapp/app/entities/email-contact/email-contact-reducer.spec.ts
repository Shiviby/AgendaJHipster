...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILCONTACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAILCONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMAILCONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMAILCONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMAILCONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMAILCONTACT actions', async () => {
      const expectedActions = [
        {
