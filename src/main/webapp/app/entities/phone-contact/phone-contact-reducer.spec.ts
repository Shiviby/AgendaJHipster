...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PHONECONTACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PHONECONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PHONECONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PHONECONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PHONECONTACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PHONECONTACT actions', async () => {
      const expectedActions = [
        {
