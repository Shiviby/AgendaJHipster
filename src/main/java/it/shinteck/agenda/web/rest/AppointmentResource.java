...
import it.shinteck.agenda.service.AppointmentQueryService;
...
/**
 * REST controller for managing {@link it.shinteck.agenda.domain.Appointment}.
 */
@RestController
@RequestMapping("/api")
public class AppointmentResource {
    ...
    public ResponseEntity<List<AppointmentDTO>> getAllAppointments(AppointmentCriteria criteria) {
        log.debug("REST request to get Appointments by criteria: {}", criteria);
        List<AppointmentDTO> entityList = appointmentQueryService.findByCriteria(criteria);
