...
import it.shinteck.agenda.service.ContactQueryService;
import it.shinteck.agenda.service.ContactService;
...
/**
 * REST controller for managing {@link it.shinteck.agenda.domain.Contact}.
 */
@RestController
@RequestMapping("/api")
public class ContactResource {
     ...
     */
    @GetMapping("/contacts")
    public ResponseEntity<List<ContactDTO>> getAllContacts(ContactCriteria criteria) {
        log.debug("REST request to get Contacts by criteria: {}", criteria);
        List<ContactDTO> entityList = contactQueryService.findByCriteria(criteria);
